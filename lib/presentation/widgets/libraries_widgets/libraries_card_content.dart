                    ...
                    Row(
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              library.name!.length > nameWidth? '${library.name!.substring(0,nameWidth.toInt())}...' : library.name!,       
                            ...
                            Row(
                              ...
                              Row(
                                  ...
                                  children: [
                                     ...
                                     SizedBox(width: screenWidth * 0.01,),
                                     Container(
                                      width: position ? screenWidth * 0.25 : screenWidth * 0.5,
                                      child: Text(keywordsString,
                                        style: Theme.of(context).textTheme.bodyMedium,),
                                      ),
                                    ],
                                ),
